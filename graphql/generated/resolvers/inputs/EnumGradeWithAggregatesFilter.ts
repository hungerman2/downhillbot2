...
import { NestedEnumGradeWithAggregatesFilter } from "../inputs/NestedEnumGradeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { Grade } from "../../enums/Grade";

@TypeGraphQL.InputType("EnumGradeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumGradeWithAggregatesFilter {
